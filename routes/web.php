...
Route::group(['middleware' => ['auth', 'auth.admin'], 'namespace' => 'Admin'], function(){
    ...
    Route::post('/admin/productos/{product}/store/{section}', 'ProductsController@store')->name('admin.products.store');
    Route::get('/admin/productos/{product}/configurar/{section?}', 'ProductsController@configure')->name('admin.products.configure');
